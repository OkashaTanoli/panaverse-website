...
function Content() {
    return (
        <div className='py-10 '>
            <div className='w-[1200px] m-auto text-zinc-800'>
                <h1 className='font-bold text-lg'>The Program in a Nutshell:&nbsp; <span className='text_gradient'>Earn While You Learn</span></h1>
                <p className='tracking-wide mt-2'>In this brand-new type of curriculum, students will learn how to make money and boost exports
                ...
                <h1 className='font-bold text-lg mt-10'>Program of Studies</h1>
                <p className='tracking-wide mt-2'>This curriculum is intended for beginners who want to learn
